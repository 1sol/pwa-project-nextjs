...
import { AimOutlined, ShareAltOutlined, HeartOutlined } from '@ant-design/icons';
				...
				<div className={styles.hospital__contents}>
					<div className={styles.hospital__search__wrap}>
						<div className={styles.hospital__search__input}>
							<Search placeholder='동, 병원명 검색' suffix={<AimOutlined className={styles.icon_location} />} />
						</div>
					...
					<div className={styles.hospital__list}>
						{hospitalDatas.list.map((item) => (
							<div key={shortid.generate()} className={styles.hospital__list__item__wrap}>
